...
INSERT INTO `log` (`id`, `news_id`, `acc`) VALUES
(24, 1, 'mem02'),
(25, 2, 'mem02');
...
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 3, 0),
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 2, 1),
